...
with st.sidebar:
    selected = option_menu('Disease Outbreak Prediction System',['Diabetes Prediction','Heart Disease Prediction','Parkinsons Prediction'],
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Check for Heart Disease'):
        ...
        if heart_pred[0]==1:
            ...
            st.success("The person is not likely to have a Heart Disease.")
